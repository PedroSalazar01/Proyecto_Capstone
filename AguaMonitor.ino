...
char* ssid = "HULUX-Z6TV";//Nombre de la red WiFi
char* pass = "tu1ZNxHumcL7";//contraseña de la red WiFi
WiFiClient clientewifi;

//configuracón MQTT
PubSubClient clienteMqtt(clienteWifi);
const char* servidorMqtt = "192.168.1.36";//Determina la dirección del broker
const char* topicNivel = "/casa/pecera/nivel"; //Topico al que va a publicar el sensor de nivel
const char* topicPote = "/casa/pecera/pote"; //Topico al que va a publicar el sentos de pH
const char* topicTemp = "/casa/pecera/temp"; //Topico al que va a publuca el sensor de temperatura
const char* topicCal= "/casa/pecera/cal"; //Topico al que va a publicar el sensor de calidad de agua
...
void setup()
{
  ...
  while (WiFi.status() != WL_CONNECTED || intentos > 30)//Mientras WiFi.status devuelva un valor diferente a WL_CONNECTED o menor a 30 intentos imprime un punto en pantalla
  {
